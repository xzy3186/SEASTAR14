...
char *ROOTFILEDIR = "/home/analysis/ribf_exp/psp14/users/xuzy/rootfiles/seastar-2014/78Ni/";
...
*/
   ...
   setup->LoadParameters("/home/analysis/ribf_exp/psp14/users/xuzy/db/MINOS.xml");
   ...
   //--------------------------------------------------------------------
   //PID Cuts
   TFile *BRcut = new TFile("/home/analysis/ribf_exp/psp14/users/xuzy/cut/brcut.root","READ");
   TFile *ZDcut = new TFile("/home/analysis/ribf_exp/psp14/users/xuzy/cut/zdcut.root","READ");
   TFile *F8QT = new TFile("/home/analysis/ribf_exp/psp14/users/xuzy/cut/F8PlaQTGate.root","READ");
   TFile *F11QT = new TFile("/home/analysis/ribf_exp/psp14/users/xuzy/cut/F11PlaQTGate.root","READ");
   TCutG *brcut;
   TCutG *zdcut;
   TCutG *f11qt;
   TCutG *f8qt;
   ...
   ifstream ConfigFile;
   ConfigFile.open("/home/analysis/ribf_exp/psp14/users/xuzy/ConfigMINOSDrift.txt");
   string HeaderFile;
   string dummystring;
