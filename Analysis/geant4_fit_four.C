...
void geant4_fit(){
   ...
   for(int i=0; i<1; i++){
      ...
      hexp[i]->GetYaxis()->SetRangeUser(1,6000);
   ...
   whole1->SetParameters(1,1,1,1,1.9,-0.000080,3.02128,-1.61704e-3);
   ...
   expon1->SetParameters(whole1->GetParameter(4),whole1->GetParameter(5),
                         whole1->GetParameter(6),whole1->GetParameter(7));
